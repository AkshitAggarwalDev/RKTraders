...
public class OwnerController {
    ...
    @GetMapping("profile")
    public OwnerEntity ownerProfile(Authentication authentication) {
    ...
    public OwnerEntity updateOwnerProfile(Authentication authentication,
                                          @RequestBody OwnerEntity updatedOwner) {
